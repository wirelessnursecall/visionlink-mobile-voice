        ...
        when (stats.type) {
            StreamType.Audio -> {
                ...
                val bandwidthLabel = AppUtils.getFormattedString(
                    ...
                    "â†‘ $uploadBandwidth kbits/s â†“ $downloadBandwidth kbits/s"
                )
            ...
            StreamType.Video -> {
                ...
                val resolutionLabel = AppUtils.getFormattedString(
                    ...
                    "â†‘ $sentResolution â†“ $receivedResolution"
                )
                ...
                if (isFecEnabled) {
                    ...
                    val fecBandwidthLabel = AppUtils.getFormattedString(
                        ...
                        "â†‘ $fecUploadBandwidth kbits/s â†“ $fecDownloadBandwidth kbits/s"
                    )
