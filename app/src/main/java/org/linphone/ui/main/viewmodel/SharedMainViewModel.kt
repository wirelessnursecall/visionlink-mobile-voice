...
class SharedMainViewModel @UiThread constructor() : ViewModel() {
    ...
    val textInfoHistoryList = MutableLiveData<String>()

    val currentAccountRegisterState = MutableLiveData<Int>() // 0: no account, 1: in progress, 2: Successfully, -1: Error, 3: Ready
