...
class HistoryListViewModel @UiThread constructor() : AbstractMainViewModel() {
    ...
    val is_show_back_button_bool = MutableLiveData<Boolean>()
    val is_show_back_button: LiveData<Int> = is_show_back_button_bool.map {
        if (it) View.VISIBLE else View.GONE
    }

    val is_show_retry_button_bool = MutableLiveData<Boolean>()
    val is_show_retry_button: LiveData<Int> = is_show_retry_button_bool.map {
        if (it) View.VISIBLE else View.GONE
    }
    ...
    init {
        ...
        is_show_back_button_bool.value = false
        is_show_retry_button_bool.value = false
